        ...
        <View className="min-h-[93vh] w-full flex flex-col justify-between px-4 mt-10">
          <View className="flex flex-col">
            ...
            <View className="flex items-center">
              ...
              <Text className="text-2xl mt-4 font-plight">
                {user.firstName}
              </Text>
            ...
            <View className="flex mt-16 px-2">
              ...
              {/* <View className="flex-row items-center">
                <Fontisto name="email" size={34} color="black" />
                <Text className="ml-4 text-lg font-pregular">{user.role}</Text>
              </View> */}
            </View>
            <View className="flex px-2 mt-16">
              <View className="flex-row items-center">
                ...
                <View className="flex-col">
                  ...
                  <Text className="ml-4 text-sm font-pregular">
                    Romana - RO
                  </Text>
                </View>
              </View>
          ...
          <View className="flex flex-col">
            <CustomButton
              title="Delogheaza-te"
              handlePress={logOut}
              containerStyles="border-2 border-[#DC143C]"
              textStyles="text-[#DC143C]"
            />
            <CustomButton
              title="Sterge cont"
              handlePress={deleteAccount}
              containerStyles="bg-[#DC143C] mt-6"
